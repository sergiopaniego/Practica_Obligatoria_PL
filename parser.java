...
String s = ", ";RESULT = s;
    ...
    case "f": structure = structure + "float "; break;
		...
		structure = structure + "<SPAN CLASS=\"ident\">"+ident1+"</SPAN>.<SPAN CLASS=\"ident\">"+ident2+"</SPAN>";
		...
		structure = structure + "</SPAN> , <SPAN CLASS=\"ident\">"+id1;
		...
		structure = structure + "<SPAN CLASS=\"ident\">"+ident1+"</SPAN>"+ldim1;
